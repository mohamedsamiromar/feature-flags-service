...
class TestToggleEndpoint:
    def test_toggle_flips_enabled_state(self, base, auth_client, flag, environment):
    ...
    def test_toggle_turns_disabled_flag_on(self, base, auth_client, flag, environment):
        EnvironmentFlagFactory(
    ...
    def test_toggle_creates_env_flag_on_first_call(self, base, auth_client, flag, environment):
    ...
    def test_toggle_writes_audit_log(self, base, auth_client, flag, environment):
        env_flag = EnvironmentFlagFactory(
            feature_flag=flag, environment=environment
        )
        auth_client.post(
    ...
    def test_toggle_missing_environment_returns_400(self, base, auth_client, flag):
        resp = auth_client.post(f"{base}/{flag.key}/toggle/", {}, format="json")
        assert resp.status_code == 400

    def test_toggle_unknown_environment_returns_404(self, base, auth_client, flag):
        resp = auth_client.post(
            f"{base}/{flag.key}/toggle/",
            {"environment": "staging"},
            format="json",
    ...
    def test_toggle_archived_flag_returns_409(self, base, auth_client, user, environment):
    ...
    def test_toggle_nonexistent_flag_returns_404(self, base, auth_client):
        resp = auth_client.post(
    ...
    def test_toggle_another_users_flag_returns_404(self, base, auth_client, environment):
    ...
    def test_toggle_another_users_environment_returns_404(self, base, auth_client, flag):
    ...
    def test_unauthenticated_toggle_returns_401(self, base, api_client, flag, environment):
